...
class LiveNews:
    ...
    def _receive_command(self, valid_commands, timeout=30):
        ...
        while command.lower() not in valid_commands and not time:
    ...
    def main_loop(self):
        while True:
            ...
            match self.screen:
                case 0:
                    print('SEJA BEM VINDO AO LIVE NEWS.')
                    ...
                    match command:
                        ...
                        case 'l':
                            ...
                            if link < 1 or link > len(self.filtered_news):
                                ...
                                # Em caso de erro aqui por utilizar linux, execute as linhas comentadas
                               
                                # if plataform == "linux" or plataform == "linux2": # Linux
                                #     chrome_path = '/usr/bin/google-chrome %s'
                                # elif platform == 'darwin': # OS X
                                #     chrome_path = 'open -a /Aplications/Google\ Chrome.app %s'
                ...
                case 3:
                    os.system('cls' if os.name == 'nt' else 'clear')
                    print('Digite o número do site para removê-lo. Caso queira voltar para o Menu, digite 0\n')
